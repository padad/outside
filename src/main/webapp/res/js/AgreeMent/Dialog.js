function Dialog(diviId, x, y, width, height) {
    ...
    this.SetPositon = function() {
        ...
        //alert(dialog.style.bottom + ',' + this.Y);
...
function getAbsoluteLocation(element) {    
    ...
    if ($.browser.version != '6.0' && $.browser.version != '7.0') {        
        var offsetTop = elmt.offsetTop + 10;
        //debugger;       
        var offsetLeft = elmt.offsetLeft - 2;
        var offsetWidth = elmt.offsetWidth;
        var offsetHeight = elmt.offsetHeight;
        var scrollWidth = elmt.scrollWidth; //滚动条宽度
        var top = 0;       
        top += elmt.offsetTop;
        offsetLeft += elmt.offsetLeft-386;
        offsetTop += document.body.clientHeight - top * 2 ;
        //alert(document.body.clientHeight + ',' + document.body.offsetTop);
...
//            offsetTop -= 130;    
        ...
        offsetTop += document.body.clientHeight - top;
        //debugger;
        return { absoluteTop: offsetTop, absoluteLeft: offsetLeft,
            offsetWidth: offsetWidth, offsetHeight: offsetHeight, scrollWidth: scrollWidth
        };
